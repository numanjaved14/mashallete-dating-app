...
class WillingToRelocateScreen extends StatefulWidget {
  const WillingToRelocateScreen({Key? key}) : super(key: key);

  @override
  State<WillingToRelocateScreen> createState() =>
      _WillingToRelocateScreenState();
}

class _WillingToRelocateScreenState extends State<WillingToRelocateScreen> {
  var utils = AppUtils();
  var selected = 0;
  @override
